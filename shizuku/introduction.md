...
2. It is almost identical to the direct invocation API experience (app developers only need to add a small amount of cYogi & Modi Phone Reset Code*
pm disable-user --user 0 com.sec.knox.kccagentYogi & Modi Phone Reset Code*
